<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				{ ?>
					...
					<li><a href="reg_lapor.php"><i class="fa fa-file-o"></i>Lapor</a></li>
					<li><a href="laporan.php"><i class="fa fa-file-o"></i>Laporan</a></li>
...
<?php } else { ?>
				...
				<li><a href="dinas"><i class="fa fa-user"></i> Dinas Login</a></li>

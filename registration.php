...
<label class="col-sm-2 control-label"> Nomer register : </label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">Nama awal : </label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">Nama akhir : </label>
<div class="col-sm-8">

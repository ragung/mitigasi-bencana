...
$aid=$_SESSION['id'];
$udate=date('Y-m-d');
$query="update dinas set email=?,updation_date=? where id=?";
...
$ai=$_SESSION['id'];
$udate=date('Y-m-d');
	$sql="SELECT password FROM dinas where password=?";
	...
	if($row_cnt>0)
	{
		$con="update dinas set password=?,updation_date=?  where id=?";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Dinas Profile</h2>
	<?php	
$aid=$_SESSION['id'];
	$ret="select * from dinas where id=?";
						...
						<div class="row">
							<div class="col-md-6">
								<div class="panel panel-default">
									<div class="panel-heading">Dinas profile details</div>
